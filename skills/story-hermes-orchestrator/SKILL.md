...
- **context 模板**：
  ...
  建立模式（第1章/新卷首章）：
  Beat 1 锚点 ~60字：地点→氛围→主角位置。一个具体动作建立性格。不要对照词碰瓷。
  Beat 2 境遇 ~80字：信息逐层铺。当前压力→主角反应→底下压着什么。愿望要小。同一信息团最多铺2次，第3次必须是新角度。
  Beat 3 日常 ~200字：全场景绕物理锚点转。次要角色互动+小物件细节+世界背景噪音。对话留白1处。此处放第1次降维评论（先拉高再砸下，≤15字）。
  Beat 4 停顿 ~40字：安静有重量。一个小细节显示时间在走。不推进任何信息。
  Beat 5 切入 ~20字：短脆独立段。事件发生。不预告不铺垫。
  Beat 6+ 危机→高潮→悬念。追逃段剃光感官只留动作。高潮感官爆发。章尾悬停不选。结尾动作/细节收束。
