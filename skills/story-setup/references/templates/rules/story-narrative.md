...
6. **禁止 AI 腔**（红线级约束）：
   ...
   - 禁止用情绪形容词替代场景展示（"他很愤怒"→删除；"手心全是汗"→保留）。限知第三人称叙事视角下，适度使用「觉得」「感到」「心情」作为叙事者旁白属于正常叙事手法，不禁止这些词本身
   - 禁止连续 5 段以上纯心理活动（关键内心转折、冥想/觉醒/顿悟场景不受此限）
...
8. **禁止 AI 腔规则的作用域**：规则 6 中的"情绪外化"（"他很愤怒"→"手在抖"）和"去解释性"仅针对**角色情绪和体验**。以下场景不适用，保留其应有风格：
   - 非人系统的描述（如系统提示音"不含任何情绪"）——这是精确描述，不是抽象判断
   - 世界观规则说明——读者需要理解机制，不能简化
   - 限知第三人称叙事者的正常旁白——「觉得」「感到」「心情」作为视角内的心理观察属于叙事手法，不应误杀
