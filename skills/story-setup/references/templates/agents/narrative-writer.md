...
**风格参考模式下的禁词表优先级**：当 style-reference-meisi.md 被加载时，banned-words.md 中与口语表达冲突的条目（不禁、不由得、心中一动、忍不住、心头一震等心理类和情态类词汇）暂停生效。原因：这些词在人类作者的网文中高频出现（如绿豆冰棍原文"王易忍不住笑意""忍不住浮想联翩"），笼统禁用会误杀自然表达。仅保留模板化句式禁令（"眼中闪过一丝XX""嘴角勾起一抹XX"等机械套话）和二级语境敏感词的高频警戒。
