...
- 字数目标：{X} 字
- 场景分解：本章包含几个场景（通常3-5个），每个场景列出：
  - 场景冲突：{这场戏里，谁想要什么 / 什么挡着他}
  - 信息释放：{这场戏读者知道了什么 / 还不知道什么 / 结尾想问什么}
  - 情绪转折：{进入时的感受 → 离开时的感受}
```

**场景设计质量指引**：场景冲突不一定是打架——一个人想走一个人想留、一个人要问一个人不说、一个人急一个人拖，都是冲突。信息释放每场戏只走一小步：揭示一点，留下新的疑问。情绪转折确保每场戏结束时读者感受与入场时不同，拒绝原地踏步的场景。
